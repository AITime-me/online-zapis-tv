...
- Сервисные уведомления о записи (подтверждение / перенос / отмена / напоминание) — отдельный контур: [bot-booking-notifications.md](./bot-booking-notifications.md). Выбор канала для подтверждения записи не создаёт marketing consent.
